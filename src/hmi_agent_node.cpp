...
void joystick_status_callback(const rio_control_node::Joystick_Status &joystick_status)
{
    ...
    output_signals.drivetrain_brake = drive_joystick->getButton(2);
    ...
    output_signals.drivetrain_quickturn = drive_joystick->getButton(3);
    ...
    output_signals.allow_shoot = button_box_1_joystick->getButton(0) || drive_joystick->getButton(1);
